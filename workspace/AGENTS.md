...
| Agent | Use for |
|-------|---------|
| `coder` | All coding tasks — building features, refactoring, PR reviews, debugging, architecture decisions. Delegates to Claude Code CLI which handles both planning and execution. |
| `planner` | Non-coding tasks only — research, long-form analysis, cross-project planning, non-technical strategy. |

### How to delegate

```
sessions_spawn task:"Build a REST API for todos in ~/Projects/myapp" agentId:"coder"
sessions_spawn task:"Design the architecture for a multi-tenant SaaS app" agentId:"coder"
sessions_spawn task:"Research the pros and cons of migrating from AWS to GCP" agentId:"planner"
```

### When to delegate vs handle yourself

**Delegate to `coder`:**
- Any task that involves writing, modifying, or debugging code
- Architecture decisions, system design, and technical planning (code-related)

**Delegate to `planner`:**
- Research, analysis, non-technical strategy
- Cross-project planning or coordination unrelated to code

**Handle yourself:**
- General conversation, Q&A, casual chat
- Reading files, checking notes, memory tasks
- Simple tool use (apple notes, weather, web search)
- Anything that doesn't need specialized capabilities
